...
function wp_scroll_depth_privacy_delarations() {
	return
	'<h2>' . __( 'User interaction information is sent to a third party' , 'wp-scroll-depth') . '</h2>' .
	'<p>' . __( 'This site monitors what content is visible in a visitor\'s browser and sends that data to Google Analytics so that we can improve our content and layout. ' , 'wp-scroll-depth') . '</p>';
}
/**
